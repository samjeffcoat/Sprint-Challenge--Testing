...
describe creates a block that groups several related tests. it can be helpful so that you can group them together.

it() is just running a a test method. these are easier to write, but will often be in our describe group.

1. What is the point of `Test Driven Development`? What do you think about this approach?
The point is to make sure our software works out of the gate.

I think I like the method because it instills confidence in your code that it will actually work and run the way you think it will.
1. Mention three types of automated tests.
User Interface
API Testing
Unit Test- Used with jest
## Project Set Up
